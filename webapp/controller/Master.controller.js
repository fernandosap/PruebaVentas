...
sap.ui.define([
		...
		"sap/ui/Device",
		"pruebaventas/PruebaVentas/model/formatter"
	], function (BaseController, JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("pruebaventas.PruebaVentas.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("pruebaventas.PruebaVentas.view.ViewSettingsDialog", this);
